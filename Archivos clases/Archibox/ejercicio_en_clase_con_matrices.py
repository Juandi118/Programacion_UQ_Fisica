...
"""Juan Diego Arias
Trabajo sobre el código de Jhon García"""
...
def ordenar_indices_2(N,vector):
    lis = []
...
print(ordenar_indices_2(3,[6,2,89,56,3])) 
print("-"*80)  
print(palabra_a_vector("Ésta: es, mi palabra{"))
print(palabra_a_vector("Hola mundo, ya es semana santa"))
print("-"*80)  
a = 4  # Tamaño de la matriz
matriz = matriznxn(a)
print(matriz)
print("-"*80)  
vector = [5, 10, 2, 8, 3, 7]
